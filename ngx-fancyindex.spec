...
Version  : 0.5.0
Release  : 7
URL      : https://github.com/aperezdc/ngx-fancyindex/archive/v0.5.0/ngx-fancyindex-0.5.0.tar.gz
Source0  : https://github.com/aperezdc/ngx-fancyindex/archive/v0.5.0/ngx-fancyindex-0.5.0.tar.gz
...
%prep
%setup -q -n ngx-fancyindex-0.5.0
cd %{_builddir}/ngx-fancyindex-0.5.0
